...
/// класс, обеспечивающий работу графического элемента "Поле для ввода кода"
open class SWCodeField: UIStackView {
  ...
  public func startInput() {
    textFields.first?.value?.becomeFirstResponder()
  }

  public var lineColor: UIColor = .systemGray {
    didSet {
      bottomLines.forEach { $0.backgroundColor = lineColor }
    }
  }

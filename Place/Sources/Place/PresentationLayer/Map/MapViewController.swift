...
public final class MapViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
  private var models: [AppendModel] = [
    .init(name: "Парк", coordin: Coordinate(longitude: 37.542472, latitude: 55.818622)),
    .init(name: "Офис", coordin: Coordinate(longitude: 37.531638, latitude: 55.741527))
  ]
